...
local default_settings = {
	...
	commands = {
        ...
        { cmd = 'doc' , description = 'Запросить документы (FBI)' ,  text = 'Здраствуйте, я {fraction_rank} ФБР&/do Cлева на груди спец-жетон ФБР.&Прошу предъявить документ, удостоверяющий вашу личность.&/n {get_nick({arg_id})}, введите /showpass {my_id}' , arg = '{arg_id}' , enable = false , waiting = '1.200', deleted = false  },
		...
		{ cmd = 'pl' , description = 'Выбросить игрока из его т/с',  text = '/me резким ударом дубинки разбивает стело т/с задержанного&/pull {arg_id}&/me выбрасывает задержанного из его т/с и ударом дубинки оглушает его', arg = '{arg_id}', enable = true, waiting = '1.200', deleted = false},	
...
function main()
	...
	while true do
		...
		if WantedWindow[0] and not update_wanted_check then -- обновление вантеда в менюшке
